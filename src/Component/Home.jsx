...
export default function Home() {
    return (
        <div className='laga relative py-[10px] px-[10px] md:px-[30px]'>
            ...
            <div className='mt-[5rem] ml-[2rem] md:ml-[4rem] md:w-[40%]'>
                <h1 className='text-[40px] md:text-[60px] md:leading-[80px] font-[500] text-amber-900 tracking-[0px] font-syne '>Embrace Your Inner Glow</h1>
                <p className='text-[18px] tracking-[px] font-[500] mb-[1rem] '>Introducing Lagada: Elegance in Every Drop</p>
